...
#define separator \
  setFile << "8"; \
  blank
#define greyedStart(x)   \
  setFile << "10|" << x; \
  blank
#define greyedEnd  \
  setFile << "11"; \
  blank
#define slider(label, var, min, max)                                  \
  setFile << "4|" << label << "|" << var << "|" << min << "|" << max; \
  blank
#define color(label, var)                  \
  setFile << "13|" << label << "|" << var; \
  blank
#define dropdown(label, var, options)                       \
  setFile << "6|" << label << "|" << var << "|" << options; \
  blank
