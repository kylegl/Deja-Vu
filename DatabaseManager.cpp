...
bool DatabaseManager::create_player(const PlayerData &player)
{
...
bool DatabaseManager::get_player(const std::string &player_id, PlayerData &player)
{
...
bool DatabaseManager::update_player(const PlayerData &player)
{
...
bool DatabaseManager::delete_player(const std::string &player_id)
{
...
bool DatabaseManager::get_all_players(std::vector<PlayerData> &players)
{
...
bool DatabaseManager::create_playlist_record(const PlaylistRecord &record)
{
...
bool DatabaseManager::get_playlist_record(int record_id, PlaylistRecord &record)
{
...
bool DatabaseManager::get_playlist_records_for_player(const std::string &player_id, std::vector<PlaylistRecord> &records)
{
...
bool DatabaseManager::update_playlist_record(const PlaylistRecord &record)
{
...
bool DatabaseManager::get_all_players_with_records(std::vector<PlayerWithRecords> &players_with_records)
{
...
bool DatabaseManager::delete_playlist_record(int record_id)
{
